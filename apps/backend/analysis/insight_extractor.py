...
# Insight extraction prompt (inlined from prompts/insight_extractor.md)
INSIGHT_EXTRACTION_PROMPT = """## YOUR ROLE - INSIGHT EXTRACTOR AGENT
...
def _build_extraction_prompt(inputs: dict) -> str:
    ...
    # Use inline prompt constant
    base_prompt = INSIGHT_EXTRACTION_PROMPT
